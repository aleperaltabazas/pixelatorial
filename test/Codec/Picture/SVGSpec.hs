...
spec = describe "Codec.Picture.SVGSpec" $ do
  describe "encodePixel"
    ...
    $ do
        encodePixel 1 (0, 0, "#fff000") `shouldBe` "<rect fill=\"#fff000\" x=\"0\" y=\"0\" width=\"1\" height=\"1\"/>"
        encodePixel 2 (20, 50, "#e5e5e5") `shouldBe` "<rect fill=\"#e5e5e5\" x=\"20\" y=\"50\" width=\"2\" height=\"2\"/>"
  describe "encodeCanvas" $ it "encodes every pixel in the matrix and wraps it in a <svg/> tag" $ do
    encodePicture
        PictureOptions { offsetX = 0, offsetY = 0, height = 2, width = 2, pixelSize = 1 }
        [(0, 0, "#ffffff"), (0, 1, "#000000"), (1, 0, "#000000"), (1, 1, "#ffffff")]
