...
spec = describe "Codec.Picture.SVGSpec" $ do
  ...
  describe "encodeCanvas" $ it "encodes every pixel in the matrix and wraps it in a <svg/> tag" $ do
    encodeCanvas (2, 2) [(0, 0, "#ffffff"), (0, 1, "#000000"), (1, 0, "#000000"), (1, 1, "#ffffff")]
      `shouldBe` "<svg viewBox=\"1 1 2 2\" xmlns=\"http://www.w3.org/2000/svg\"><rect fill=\"#ffffff\" x=\"0\" y=\"0\" width=\"1\" height=\"1\"/><rect fill=\"#000000\" x=\"0\" y=\"1\" width=\"1\" height=\"1\"/><rect fill=\"#000000\" x=\"1\" y=\"0\" width=\"1\" height=\"1\"/><rect fill=\"#ffffff\" x=\"1\" y=\"1\" width=\"1\" height=\"1\"/></svg>"
